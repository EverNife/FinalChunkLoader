...
@LayoutBaseData(
        title = "➲  §2§lChunkLoader Vip",
        rows = 5
)
public class ChunkLoaderPremiumEditLayout extends ChunkLoaderEditLayout {
    ...
    public LayoutIcon CYAN_BACKGROUND = EnumStainedGlassPane.CYAN
            .asLayout();
